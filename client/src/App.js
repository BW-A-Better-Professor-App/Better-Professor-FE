  ...
  useEffect(() => {
    ...
    if (!isActive) {
      axiosWithAuth()
        ...
        .then(response => {
          console.log(
            "this is the response from task get call for all",
            response
          );
          const filteredDeadlines = response.data.filter(
      ...
      axiosWithAuth()
        ...
        .then(response => {
          console.log(
            "this is the response from task get call for a student",
            response
          );
          const studentFilteredDeadlines = response.data.filter(
            data =>
              data.lastname === activeStudent.lastname && data.task_id !== null
          );
          // const sortedDeadlines= filteredDeadlines.sort((a,b) => b.due_date-a.due_date);
          console.log(
            "this is the filtered student Deadlines",
            studentFilteredDeadlines
          );
